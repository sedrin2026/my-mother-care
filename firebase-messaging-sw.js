self.addEventListener("notificationclick",(event)=>{
  ...
  const u=new URL("./responses.html",self.location).href;
  event.waitUntil(
...
messaging.onBackgroundMessage((payload)=>{
  console.log("[MY MOTHER CARE] background FCM:",payload);
  ...
  return self.registration.showNotification(
    d.title||"💌 母ちゃんから返事が届きました",
    {
      body:d.body||"新しい返事が届いたので確認してください。",
      icon:"./my-mother-care-nanohana-header-v17.webp",
      tag:"my-mother-care-response",
      renotify:true,
